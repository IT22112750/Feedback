...
<html>
<head>
<title>User Payment Application</title>
<link rel="stylesheet"
...
<body>
	...
	<header>
		<nav class="navbar navbar-expand-md navbar-dark"
			...
			<div>
				<a href="https://www.javaguides.net" class="navbar-brand"> Responses </a>
			</div>
	...
	<div class="container col-md-5">
		<div class="card">
			<div class="card-body">
				...
				<fieldset class="form-group">
					<label>Responses</label> <input type="text"
						value="<c:out value='${user.comments}' />" class="form-control"
